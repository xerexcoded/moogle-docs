...
function Header() {
    ...
    return (
        <header className ='sticky top-0 z-50 flex items-center px-4 px-y shadow-md bg-white'> 
            ...
            <div className="mx-5 md:mx-20 flex flex-grow items-center px-5 py-2 bg-gray-100 text-gray-600 rounded-lg focus-within:text-gray-600 focus-within:shadow-md">
                ...
                <input type="text" placeholder="Search" className="px-5 flex-grow text-base bg-transparent outline-none"/>
            </div>
            <Button
            color="gray"
            buttonType="outline"
